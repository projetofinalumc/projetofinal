            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                        ...
                        <form action="/Admin/BuscarPedido" method="post">
                        <div class="card">
                                    <!-- <div class="card-header">Credit Card</div> -->
                          
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2">Buscar Pedido</h3>
                                        </div>
                                        <hr>
                                            
                                                <div>
                                                <label for="id_Pedido" class="control-label mb-1">Digite o Id do Pedido: </label>
                                                </div>
                                                <br>
                                                <div>
                                                <input id="id_Pedido" name="id_Pedido" type="number" class="form-control" aria-required="true" aria-invalid="false">
                                                </div>
                                                <br>
                                                <div>
                                                ...
                                                <!-- <div>
                                                     <a href="/Admin/ListandoPedido" class="btn btn-info"></a>
                                                </div> -->
